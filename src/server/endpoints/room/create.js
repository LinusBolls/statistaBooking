...
var createQuery = {
    ...
    data: {
        ...
        title: __spreadArray(__spreadArray([], input.room.title), ["required"]),
        description: input.room.description,
        workstations: __spreadArray(__spreadArray([], input.room.workstations), ["required"]),
    },
};
exports.query = createQuery;
var createRoom = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var tokenData, newRoom, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                tokenData = authToken.auth(req.body.token);
                newRoom = new index.Room(req.body.data);
            ...
            case 3:
                ...
                res
                    .type("json")
                    .send({ success: false, reason: "Error saving room: " + e_1 });
                return [2 /*return*/];
            case 4: return [2 /*return*/, res.type("json").send({ success: true })];
        }
    });
}); };
exports.handler = createRoom;
