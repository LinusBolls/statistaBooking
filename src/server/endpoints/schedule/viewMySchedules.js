...
var viewMySchedules = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var tokenData, schedules;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, index.Schedule.find({ user: tokenData.email })];
            case 1:
                schedules = _a.sent();
...
exports.handler = viewMySchedules;
