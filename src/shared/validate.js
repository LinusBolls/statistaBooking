...
var sharedProjectConfig_1 = require("./sharedProjectConfig");
var validate = function (body, rules, customMessages) {
    if (customMessages === void 0) { customMessages = {}; }
    return new Promise(function (resolve, _) {
        var validation = new Validator(body, rules, customMessages);
        validation.passes(function () { return resolve({ success: true }); });
        validation.fails(function () {
            return resolve({ success: false, reason: validation.errors });
        });
    });
};
exports.validate = validate;
var validateReqBody = function (query) {
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, validate(req.body, query)];
                case 1:
                    data = _a.sent();
                    data.success
                        ? next()
