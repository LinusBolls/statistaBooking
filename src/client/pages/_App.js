...
var AppHeader_1 = __importDefault(require("../components/AppHeader"));
var Login_1 = __importDefault(require("./Login"));
var Account_1 = __importDefault(require("./Account"));
var Register_1 = __importDefault(require("./Register"));
var MailConfirm_1 = __importDefault(require("./MailConfirm"));
var TimeTable_1 = __importDefault(require("./TimeTable"));
var RoomView_1 = __importDefault(require("./RoomView"));
var ScheduleView_1 = __importDefault(require("./ScheduleView"));
function App() {
    ...
    react_1.useEffect(function () {
        window.addEventListener(event_1.Event.USERINFO_UPDATE, function (e) {
            return setUser(__assign(__assign({}, user), JSON.parse(e.detail)));
        });
    ...
    return (react_1["default"].createElement(react_router_dom_1.BrowserRouter, null,
        react_1["default"].createElement("div", { id: "app", className: "App" },
            react_1["default"].createElement(AppHeader_1["default"], { user: user }),
